...
document.addEventListener('DOMContentLoaded', function () {
  window.favCarousel = function () {
    ...
    var favflkty = new Flickity(fav, _defineProperty({
      cellAlign: 'left',
      contain: true,
      groupCells: true
    }, "groupCells", 3));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var blazy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/blazy/blazy.js");
...
document.addEventListener('DOMContentLoaded', function () {
  var el = document.getElementsByClassName('js-nav')[0],
  ...
  var init = function init() {
    ...
    */
    ...
    var parent = menu.getElementsByTagName('li');
    ...
    var submenu = function submenu(e) {
      ...
      if (item.classList.contains('menu-item-has-children')) {
        ...
        window.open(url, '_self'); //hideMenu();
      }
